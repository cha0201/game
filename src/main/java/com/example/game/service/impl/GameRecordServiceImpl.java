...
public class GameRecordServiceImpl implements GameRecordService {
    ...
    public List<GameRecordStatistics> getRecordStatistics(String time, String account, String operator) {
        ...
        String columnCondition1=" record_account as account, 1 as pourNum, record_amount as pourAmount, record_valid_amount as effectAmount, record_gain profitAmount, (select user_nick_name from game_user where game_user_id=game_record.game_user_id) as operator " ;
